...
public class Main extends HttpServlet {
	...
	public void doExecute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		String domain = "";
		...
		try {
			...
			web.parse();
			// -------------rank-----------------
			ArrayList<KeyPhraseScore> rankResult = BM25F.rank(web.getWebpageMeta(), web.getAPIMeta(),
					web.getPhraseMap());
			// -------------sort and output------------
